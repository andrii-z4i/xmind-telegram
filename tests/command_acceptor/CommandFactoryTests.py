    ...
    def test_valid_cases_validation(self):
        ...
        _input_dict = dict(
            [('create file "file name"',
             ...
             ('creat sheet "entity name"',
              Command(operation='create', subject='sheet', name='entity name', virtual_id=None, user_id=_user_id, chat_id=_chat_id)),
             ('delete topic 23',
              Command(operation='delete', subject='topic', name=None, virtual_id=23, user_id=_user_id, chat_id=_chat_id)),
             ('12 file delet',
             ...
             ('select topic 33',
              Command(operation='select', subject='topic', name=None, virtual_id=33, user_id=_user_id, chat_id=_chat_id)),
             ('file 34 slct',
