...
from cmp_telegram_pusher.src.controllers.implementations.QueueChannel import QueueChannel
from typing import Tuple


class QueueChannelTest(TestCase):

    @patch("cmp_telegram_pusher.src.controllers.implementations.QueueChannel.ConnectionParameters")
    @patch("cmp_telegram_pusher.src.controllers.implementations.QueueChannel.BlockingConnection")
